...
CREATE TABLE "Sup" (
    "id" SERIAL NOT NULL,
    "manufacturer" TEXT NOT NULL DEFAULT E'',
    "productRef" TEXT NOT NULL DEFAULT E'',
    "name" TEXT NOT NULL,
    "collection" TEXT,
    "type" TEXT,
    "categories" TEXT,
    "capsuleAmount" INTEGER NOT NULL DEFAULT 0,
    "servingSize" INTEGER NOT NULL DEFAULT 0,
    "wMeal" BOOLEAN NOT NULL DEFAULT false,
    "caution" TEXT,
    "ingredients" TEXT,
    "otherIngredients" TEXT,
    "proprietaryBlend" TEXT,
    "createdAt" TIMESTAMP(3) NOT NULL DEFAULT CURRENT_TIMESTAMP,
    "updatedAt" TIMESTAMP(3) NOT NULL,
...
-- CreateIndex
CREATE UNIQUE INDEX "Sup_name_key" ON "Sup"("name");
